...
import 'package:signal/models/Model.dart';
...
class _InboxState extends State<Inbox> {
  List<ChatMessage> messages = [
    ...
    ChatMessage(messageContent: "hi, bro", messageType: "sender"),
    ChatMessage(messageContent: "how are you doing", messageType: "receiver"),
    ChatMessage(messageContent: "I am fine, bro", messageType: "sender"),
    ChatMessage(messageContent: "What about you bro?", messageType: "receiver"),
    ChatMessage(messageContent: "Im fine here!", messageType: "sender"),
  ];
